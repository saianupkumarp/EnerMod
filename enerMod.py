...
@login_required
def home():
    return render_template('home.html', modelcountry = data.get_dist_modelCountry(), owner = data.get_dist_username(), modeltype = data.get_dist_modelType(), submodels = data.get_dist_sub_models(), funclist = data.get_dist_func(), mainversionList = data.get_main_version(current_user.username))
