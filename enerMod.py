...
@login_required
def home():
    return render_template('home.html', modeltype = data.get_dist_modelType())#, modelcountry = data.get_dist_modelCountry(), owner = data.get_dist_username(),  submodels = data.get_dist_sub_models(), funclist = data.get_dist_func(), mainversionList = data.get_main_version(current_user.username))
