...
def fact_insertion(key, values, modelName, subModel, funcName, mainVerion, country, username):
    ...
    factsUpdate = models.FactEntitlements.query.filter_by(CNTRY_ID=country,MODEL_ID=modelName,SM_ID=subModel,FUNC_ID=funcName,MAIN_VERSION=mainVerion,USERNAME=username,LAST_EDIT_END_DATE=None).update({"LAST_EDIT_END_DATE": utcNow})
